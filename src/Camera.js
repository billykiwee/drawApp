        ...
        <main id="camera" >
            ...
            <div className="grid h-100vh overflow-hidden">
                ...
                <div className="display justify-c">
                    ...
                    <div className="w-100 h-100 grid absolute overflow-hidden zi-2">

                        {
                            ...
                            <div className='display justify-c w-100 gap zi-2' style={{height: '10vh'}} >
                                ...
                                <div className='display white border-r-1'>
                                    <ButtonControl onClick={e=> setZoom(Zoom !== 100 ? Zoom - widthStep : Zoom)} >
                    ...
                    <video  style={{transform: `scale(${Zoom/100})`}}  controls={false} id="camera--view" autoPlay playsInline className='transition w-100 h-100vh fit-cover' /> 
                </div>
...
function ButtonControl({children, onClick}) {
    ...
    return (
        <div className='display'>
            <button type='button' className='click white h-3 w-3 hover-white' onClick={onClick}>
